...
# Измерение времени для последовательного выполнения
start_time = perf_counter()

# Последовательный вызов функции с разными аргументами
...
# Измерение времени для параллельного выполнения с потоками
start_time = perf_counter()
